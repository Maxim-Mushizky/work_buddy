...
def register_page(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request, "There was an error during registeration") 
...
def user_profile(request, pk):
    ...
    rooms = user.room_set.all() # all mdoels children
...
def delete_message(request, pk):
    ...
    if request.method == 'POST':
        message.delete()
        return redirect('room', pk=message.room.id) # redirect by name 
